...
class CommandController extends AgentController {
    ...
    public function add_cashpoint(){
        ...
        $this->display('Agent:add_cashpoint');
    }
    ...
    public function add_cashpoint_result(){
         ...
         if(empty($gameid))
         {
             $this->redirect('Agent:add_cashpoint','',2, '亲，参数为空!!!');
         }
         ...
         for($i = 0; $i < $count;$i++){
             ...
             if($httpstr == "SUCCESS")
             {
                 //$this->redirect('Agent:add_cashpoint','',3, '亲，发送命令成功!稍后请查询!!');
             }
             else
             {
                 $this->redirect('Agent:add_cashpoint','',3, '亲，充值失败!!!');
             }
         }
         $this->redirect('Agent:add_cashpoint','',3, '亲，发送命令成功!稍后请查询!!');
    }
    ...
    public function cdkey(){
     ...
     public function item(){
       ...
       // dump($_POST);
                    ...
                    $enddate = date('Y-n-j');
                        //$this->redirect('Agent:itemlog','',1, '亲，日期不能为空!!!');
                    }
...
"addrewardid"
    ...
    public function add_cdkey(){
        ...
        if(IS_POST){
            ...
            {
                $this->redirect('Agent:cdkey','',1, '亲，参数为空!!!');
            }

            //if(!($count) || !is_int($gift))
            //{
            //    $this->redirect('Agent:cdkey','',3, '亲，整数!!!');
            //}
            ...
            //dump($res);
            if($res){
               return   $this->redirect('Agent:cdkey','',1, '亲，添加成功!');
            }
        }
        $this->redirect('Agent:cdkey','',1, '亲，添加失败!');
    }
    ...
    public function mail(){
        if(IS_POST){
            ...
            if($IsAll == 0){
                ...
                {
                    $this->redirect('Agent:mail','',3, '亲，参数为空!!!');
                }
            }
            else{
                $DestUserID = 0;
            ...
            if($httpstr == "SUCCESS")
            {
                $this->redirect('Agent:mail','',3, '亲，发送命令成功!稍后请查询!!');
            }
            else
            {
                $this->redirect('Agent:mail','',3, '亲，发送失败!!!');
            }
        }
        else{
            $curuserid = get_current_userid();
    ...
    public function broadcast(){
        if(IS_POST){
            ...
            {
                $this->redirect('Agent:broadcast','',3, '亲，参数为空!!!');
            }
            ...
            if($httpstr == "SUCCESS")
            {
                $this->redirect('Agent:broadcast','',3, '亲，发送命令成功!稍后请查询!!');
            }
            else
            {
                $this->redirect('Agent:broadcast','',3, '亲，发送失败!!!');
            }
        }
        else{
            $this->display('Agent:broadcast');
        }
    }
    ...
    public function kick(){
        if(IS_POST){
            ...
            {
                $this->redirect('Agent:kick','',3, '亲，参数为空!!!');
            }
            //if(empty($Context))
            //{
            //    $Context = "System Send!";
            ...
            if($httpstr == "SUCCESS")
            {
                $this->redirect('Agent:kick','',3, '亲，发送命令成功!稍后请查询!!');
            }
            else
            {
                $this->redirect('Agent:kick','',3, '亲，发送失败!!!');
            }
        }
        else{
            $curuserid = get_current_userid();
    ...
    public function set_black(){
        if(IS_POST){
            ...
            if(empty($DestUserID))
            {
                $this->redirect('Agent:set_black','',3, '亲，参数为空!!!');
            }
            $arr_db_url = get_db_config_url();
            ...
            if($httpstr == "SUCCESS")
            {
                $this->redirect('Agent:set_black','',3, '亲，发送命令成功!稍后请查询!!');
            }
            else
            {
                $this->redirect('Agent:set_black','',3, '亲，发送失败!!!');
            }
        }
        else{
            $curuserid = get_current_userid();
    ...
    public function unset_black(){
        if(IS_POST){
            ...
            if(empty($DestUserID))
            {
                $this->redirect('Agent:unset_black','',3, '亲，参数为空!!!');
            }
            $arr_db_url = get_db_config_url();
            ...
            if($httpstr == "SUCCESS")
            {
                $this->redirect('Agent:unset_black','',3, '亲，发送命令成功!稍后请查询!!');
            }
            else
            {
                $this->redirect('Agent:unset_black','',3, '亲，发送失败!!!');
            }
        }
        else{
            $curuserid = get_current_userid();
            ...
            $this->display('Agent:unset_black');
        }
    }
    public function silent(){
        if(IS_POST){
            ...
            if(empty($RewardNum)||empty($DestUserID))
            {
                $this->redirect('Agent:silent','',3, '亲，参数为空!!!');
            }
            if(empty($Context))
            {
                $Context = "System Send!";
            ...
            if($httpstr == "SUCCESS")
            {
                $this->redirect('Agent:silent','',3, '亲，发送命令成功!稍后请查询!!');
            }
            else
            {
                $this->redirect('Agent:silent','',3, '亲，发送失败!!!');
            }
        }
        else{
            $this->display('Agent:silent');
        }
    }
    ...
    public function reloadconfig(){
        if(IS_POST){
            ...
            if($httpstr == "SUCCESS")
            {
                $this->redirect('Agent:reloadconfig','',3, '亲，发送命令成功!稍后请查询!!');
            }
            else
            {
                $this->redirect('Agent:reloadconfig','',3, '亲，发送失败!!!');
            }
        }
        else{
            $this->display('Agent:reloadconfig');
        }
    }
    ...
    public function handleentity(){
        if(IS_POST){
            ...
            {
                $this->redirect('Agent:handleentity','',3, '亲，参数为空!!!');
            }
            ...
            if($httpstr == "SUCCESS")
            {
                $this->redirect('Agent:handleentity','',3, '亲，发送命令成功!稍后请查询!!');
            }
            else
            {
                $this->redirect('Agent:handleentity','',3, '亲，发送失败!!!');
            }
        }
        else{
            $this->display('Agent:handleentity');
        }
    }

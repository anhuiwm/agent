...
<body>
 ...
 <?php if(is_array($SEC_MENU)): foreach($SEC_MENU as $key=>$row): ?><div class="panel panel-default">
    ...
    <form method="post" action="<?php echo U('GmTool/Command/add_cashpoint_result');?>">
        <input type="text" class="form-control" value="<?php echo ($curuser); ?>" placeholder="UserID" name="gameid">
        <select class="form-control" name="shopid">
            <option value="11" >少量点券60   </option>
            <option value="12" >小堆点券300  </option>
            <option value="13" >小袋点券980  </option>
            <option value="14" >大袋点券1980 </option>
            <option value="15" >满箱点券3280 </option>
            <option value="16" >满柜点券6480 </option>	
            <option value="41">购买月卡</option>
            <option value="51">一元豪礼活动用</option>
		</select>
